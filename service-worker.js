...
const CACHE_NAME = 'sohojtech-shell-v18'; // ✅ v11→v12: subscription-promo.js যোগ হয়েছে PRECACHE_URLS-এ, তাই বাম্প করা হলো
...
const PRECACHE_URLS = [
  ...
  './js/subscription-promo.js', './js/modules/contact.js', './js/modules/onboarding.js',
